...
function getRouteHandler(_ref) {
  var type = _ref.type;
  var key = _ref.key;
  var routes = __plugins[type].routes;

  var eventKeyArray = key.split('/');
  ...
  return Object.keys(routes).reduce(function (curr, routeKey) {
    ...
    for (var i in routeKeyArray) {
      ...
      var isMatch = !isKeyMatch && !isParamMatch && !isKeyMissing;
...
var Router = function (_EventEmitter) {
  ...
  function Router(_ref2) {
    ...
    var store = _ref2$store === undefined ? {} : _ref2$store;
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  output = typeof route[i] === 'function' ? route[i](state.toJS(), ctx) : {};
